...
class AppNetworking{
    ...
    func getData(input: String, completion: @escaping ([Article]) -> Void, failure: @escaping (String)-> Void){
        ...
        var todosEndpoint: String = "https://newsapi.org/v2/everything?qInTitle=\(input)&from=2024-09-07&language=en&sortBy=publishedAt&apiKey=658e70f34814444a974230be0e84c5fc"
